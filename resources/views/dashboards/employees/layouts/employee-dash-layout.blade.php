  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ url('public/Image/'.Auth::user()->picture) }}" class="img-circle elevation-2 employee_picture" alt="User Image">
        </div>
        <div class="info">
          <a href="{{route('employee.profile')}}" class="d-block employee_name h4">{{ Auth::user()->name }}</a>
        </div>
      </div>
      <!-- Sidebar Menu -->
      <nav class="mt-2">
...
<!-- EmployeeLTE App -->
<script src="{{asset('assets/js/emloyeelte.min.js')}}"></script>
...
<script>
  ...
  $(function(){
           ...
           success:function(data){
                if(data.status == 0){
                  ...
                  $('.employee_name').each(function(){
                     $(this).html( $('#EmployeeInfoForm').find( $('input[name="name"]') ).val() );
                  });
                  alert(data.msg);
                }
           }
    ...
    $('#employee_image').ijaboCropTool({
          preview : '.employee_picture',
          setRatio:1,
          allowedExtensions: ['jpg', 'jpeg','png'],
          buttonsText:['CROP','QUIT'],
          buttonsColor:['#30bf7d','#ee5155', -15],
          processUrl:'{{ route("employeePictureUpdate") }}',
    ...
    $('#changePassworEmployeedForm').on('submit', function(e){
         e.preventDefault();
         ...
         $.ajax({
            ...
            success:function(data){
              if(data.status == 0){
                ...
                $('#changePasswordEmployeeForm')[0].reset();
                alert(data.msg);
              }
            }
         });
